...
export function DedupeL1Panel({ datasetPath }: { datasetPath: string }) {
  return (
    <ClusterView
...
export function SimilarityL2Panel({ datasetPath }: { datasetPath: string }) {
  return (
    <ClusterView
      datasetPath={datasetPath}
      kind="ai"
...
function DupeMemberTile({
  ...
  return (
    <div
      className={cn(
        "relative flex w-full max-w-full min-w-0 flex-col overflow-hidden rounded border",
