...
MESSAGES: dict[str, dict[Lang, str]] = {
    ...
    "tag.model_help": {"zh": "WD tagger 模型 id(joytag 忽略)。内置 SmilingWolf 模型可映射到 ModelScope。", "en": "WD tagger model id (ignored for joytag). Built-in SmilingWolf models can map to ModelScope."},
    "tag.source_help": {"zh": "WD14 下载源:'auto'(遵循网络设置)、'huggingface' 或 'modelscope'。", "en": "WD14 download source: 'auto' (honor network settings), 'huggingface', or 'modelscope'."},
    ...
    "tag.unknown_source": {"zh": "[red]未知下载源 {name!r};可选 auto、huggingface 或 modelscope[/red]", "en": "[red]unknown download source {name!r}; expected auto, huggingface, or modelscope[/red]"},
    ...
    "tag.loading_wd": {"zh": "[dim]正在加载 {model}(下载源:{source},首次约 1.3GB)...[/dim]", "en": "[dim]loading {model} (source: {source}, first download ~1.3GB)...[/dim]"},
